...
def reset():
  ...
  type = type + """, running an interview with a candidate. Do not ask all the questions at once. 
  Ask the candidate 5 individual questions, one at a time and allow the candidate can respond to 
  each question before going on to the next. And then ask the candidate if they have any questions 
  for you. Make all the responses as concise as possible with a little humor expression."""
